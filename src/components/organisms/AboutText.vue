<template>
  <div>
    ...
    <div class="mb-8">
      <figure>
        <embed src="https://wakatime.com/share/@zvekov/9ec93ffd-1d63-4de1-a88a-b9eaa0569750.svg"></embed>
      </figure>
    </div>
  </div>
</template>
...
.stack {
  & > a {
    @apply flex justify-center bg-white border border-gray-200 h-16 w-auto rounded-lg p-2 transform transition-all duration-300 cursor-pointer;
